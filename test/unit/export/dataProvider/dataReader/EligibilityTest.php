...
class EligibilityTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->service = (new Eligibility())->setServiceLocator(
    ...
    public function testGetData()
    {
        $this->ontologyMock->expects($this->once())
            ->method('getClass')->with('http://www.tao.lu/Ontologies/TAOProctor.rdf#DeliveryEligibility');

        $this->classMock->expects($this->once())
            ->method('searchInstances')
            ->with(
                ['http://www.tao.lu/Ontologies/TAOProctor.rdf#EligibileTestCenter' => 'uri'],
