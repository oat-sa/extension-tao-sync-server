...
class DeliveryTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = (new Delivery())->setServiceLocator(
    ...
    {
        $data = [
            ['http://www.tao.lu/Ontologies/TAOProctor.rdf#EligibileDelivery' => 'uri1'],
            ['http://www.tao.lu/Ontologies/TAOProctor.rdf#EligibileDelivery' => 'uri2'],
        ];
    ...
    {
        $data = [
            ['http://www.tao.lu/Ontologies/TAOProctor.rdf#EligibileDelivery' => ['uri1', 'uri3']],
            ['http://www.tao.lu/Ontologies/TAOProctor.rdf#EligibileDelivery' => 'uri2'],
        ];
    ...
    public function testGetDataWithInvalidParameter()
    {
        ...
        (new Delivery())->getData(['data']);
    }

    public function testGetDataWithInvalidParameters()
    {
        $this->expectException(SyncDataProviderException::class);
        (new Delivery())->getData([['key' => 'value']]);
    }
}
